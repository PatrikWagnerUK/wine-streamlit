...
def recommend_wine(sig_kern=sig_kern):
    ...
    if st.button("Recommend Wine"):
        ...
        st.write('[Purchase Wine]' + '(' + s_url1 + ')', unsafe_allow_html=True)
        st.markdown("____")
        ...
        st.write('[Purchase Wine]' + '(' + s_url2 + ')', unsafe_allow_html=True)
        st.markdown("____")
        ...
        st.write('[Purchase Wine]' + '(' + s_url3 + ')', unsafe_allow_html=True)
